...
## Project Structure
    ...
    ├── indep_user_flow_mob_32142  # Django project configurations
...
1. Clone this repo and `cd indep_user_flow_mob_32142`
...
2. Clone this repo and `cd indep_user_flow_mob_32142`
